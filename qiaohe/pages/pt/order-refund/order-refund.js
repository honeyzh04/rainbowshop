...
Page({
    ...
    onLoad: function(t) {
        ...
        var i = this;
        e.request({
            url: a.group.order.refund_preview,
            data: {
                order_id: t.id
            },
            success: function(t) {
    ...
    refundSubmit: function(i) {
        ...
        if (1 == n) {
            var s = function() {
                ...
                if (0 == (o = d.data.refund_data_1.desc || "").length) return wx.showToast({
                    title: "请填写退款原因",
                    image: "/images/icon-warning.png"
                }), {
                    v: void 0
                };
                if (c = [], r = 0, d.data.refund_data_1.pic_list && d.data.refund_data_1.pic_list.length > 0) {
                    wx.showLoading({
                        title: "正在上传图片",
                        mask: !0
                    });
                    for (u in d.data.refund_data_1.pic_list) !function(e) {
                        wx.uploadFile({
                            ...
                            success: function(t) {},
                            complete: function(a) {
                                r++, 200 == a.statusCode && 0 == (a = JSON.parse(a.data)).code && (c[e] = a.data.url), 
                                r == d.data.refund_data_1.pic_list.length && (wx.hideLoading(), t());
                            }
                        });
                    }(u);
                } else t();
        ...
        if (2 == n) {
            var o, c, r, u, _ = function() {
                ...
                if (0 == (o = d.data.refund_data_2.desc || "").length) return wx.showToast({
                    title: "请填写换货说明",
                    image: "/images/icon-warning.png"
                }), {
                    v: void 0
                };
                if (c = [], r = 0, d.data.refund_data_2.pic_list && d.data.refund_data_2.pic_list.length > 0) {
                    wx.showLoading({
                        title: "正在上传图片",
                        mask: !0
                    });
                    for (u in d.data.refund_data_2.pic_list) !function(e) {
                        wx.uploadFile({
                            url: a.default.upload_image,
                            ...
                            complete: function(a) {
                                r++, 200 == a.statusCode && 0 == (a = JSON.parse(a.data)).code && (c[e] = a.data.url), 
                                r == d.data.refund_data_2.pic_list.length && (wx.hideLoading(), t());
                            }
                        });
                    }(u);
                } else t();
            }();
            if ("object" === (void 0 === _ ? "undefined" : t(_))) return _.v;
        }
    }
});