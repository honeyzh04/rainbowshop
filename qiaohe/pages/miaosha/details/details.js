...
Page({
    ...
    numberAdd: function() {
        var t = this, a = t.data.form.number;
        if (++a > t.data.goods.miaosha.buy_limit && 0 != t.data.goods.miaosha.buy_limit) return wx.showToast({
            title: "一单限购" + t.data.goods.miaosha.buy_limit + "件",
    ...
    numberBlur: function(t) {
        ...
        o = parseInt(o), isNaN(o) && (o = 1), o <= 0 && (o = 1), o > a.data.goods.miaosha.buy_limit && 0 != a.data.goods.miaosha.buy_limit && (wx.showToast({
            title: "一单限购" + a.data.goods.miaosha.buy_limit + "件",
            image: "/images/icon-warning.png"
        }), o = a.data.goods.miaosha.buy_limit), a.setData({
            form: {
                number: o
            }
        });
